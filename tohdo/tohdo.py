...
from utils.quotes import get_rand_quote
...
@app.command()
def tohdo():
    """[bold blue]Show[/bold blue] the banner :sparkles:"""
    banner()
...
@app.callback(
    ...
    epilog='Made with [red]:heart:[/red] by Brinsil Elias',
)
def show(ctx: typer.Context) -> None:
    """
    💻 [bold]Tohdo[/]

    ・[i]Minimalist and full configurable TODO list[/]・
    """
    try:
